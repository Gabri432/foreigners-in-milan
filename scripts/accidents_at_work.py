...
def display_data(starting_year, ending_year):
    ...
    ax1.set_xlabel("Anno")
    ax1.plot(amounts['year'], amounts['total']["italians"], color='#0099FF', zorder=2, alpha=0.8, label="Infortuni d'italiani")
    ax2.plot(amounts['year'], amounts['total']["foreigners"], color='skyblue', zorder=2, alpha=0.7, label="Infortuni di stranieri")
