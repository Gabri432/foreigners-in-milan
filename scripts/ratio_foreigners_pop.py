...
def sequence(starting_year, ending_year, jump_years):
    ...
    plt.bar(amounts['year'], amounts["tot_pop"], color='#0099FF', label='Italiani', zorder=2, alpha=0.5)
    plt.bar(amounts['year'], amounts["foreigners_pop"], bottom=amounts["tot_pop"], color="skyblue", label='Stranieri', zorder=2, alpha=0.5)
    #plt.bar(amounts['year'], amounts["tot_pop"], bottom=amounts["foreigners_pop"], color='#0099FF', label='Italiani', zorder=2, alpha=0.5)
